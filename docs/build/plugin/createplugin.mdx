...
```bash
go mod init github.com/my-username/hello-world
```
...
Now, you need a logo.
- Run `mkdir -p web/content && touch web/content/hello_world.svg` to create the file.
...
> This will generate a `cmd/hello-world-server/hello-world.go` file, that will be the entry point of your plugin
...
- Set the handler for the endpoints
  - create a hello-world.go file in the root of your project : `touch hello-world.go`
...
- register your plugin on massastation
  - add the following package into the `hello-world.go` file : `github.com/massalabs/station-massa-hello-world`
